...
// Vowels that sound similar
        // Group 1: ㅏ and ㅓ (a vs eo)
        'ㅏ': ['ㅏ', 'ㅓ'],
        'ㅓ': ['ㅏ', 'ㅓ'],
        
        // Group 2: ㅗ and ㅓ and ㅜ (o vs eo vs u)
        'ㅗ': ['ㅗ', 'ㅓ', 'ㅜ'],
        
        // Group 3: ㅜ and ㅡ and ㅗ (u vs eu vs o)
        'ㅜ': ['ㅜ', 'ㅡ', 'ㅗ'],
        'ㅡ': ['ㅜ', 'ㅡ', 'ㅣ'],
        
        // Group 4: ㅐ and ㅔ and ㅣ (ae vs e vs i) - almost identical in modern Korean
        'ㅐ': ['ㅐ', 'ㅔ', 'ㅣ'],
        'ㅔ': ['ㅐ', 'ㅔ', 'ㅣ'],
        
        // Group 5: ㅒ and ㅖ and ㅣ (yae vs ye vs i)
        'ㅒ': ['ㅒ', 'ㅖ', 'ㅣ'],
        'ㅖ': ['ㅒ', 'ㅖ', 'ㅣ'],
        
        // Group 6: ㅚ, ㅙ, ㅞ, ㅔ, ㅟ (oe, wae, we, e, wi) - all sound like "e/we/wi"
        'ㅚ': ['ㅚ', 'ㅙ', 'ㅞ', 'ㅔ', 'ㅟ', 'ㅣ'],
        'ㅙ': ['ㅚ', 'ㅙ', 'ㅞ', 'ㅔ', 'ㅐ'],
        'ㅞ': ['ㅚ', 'ㅙ', 'ㅞ', 'ㅔ', 'ㅔ'],
        
        // Group 7: ㅟ and ㅣ and ㅚ (wi vs i vs oe) - often confused
        'ㅟ': ['ㅟ', 'ㅣ', 'ㅚ', 'ㅡ'],
        'ㅣ': ['ㅣ', 'ㅟ', 'ㅔ', 'ㅐ', 'ㅡ'],
        
        // Group 8: ㅘ and ㅗ and ㅏ (wa vs o vs a)
        'ㅘ': ['ㅘ', 'ㅗ', 'ㅏ'],
        
        // Group 9: ㅝ and ㅓ and ㅜ (wo vs eo vs u)
        'ㅝ': ['ㅝ', 'ㅓ', 'ㅜ'],
        
        // Group 10: ㅑ and ㅏ and ㅣ (ya vs a vs i)
        'ㅑ': ['ㅑ', 'ㅏ', 'ㅣ'],
        
        // Group 11: ㅕ and ㅓ and ㅣ (yeo vs eo vs i)
        'ㅕ': ['ㅕ', 'ㅓ', 'ㅣ'],
        
        // Group 12: ㅛ and ㅗ and ㅜ (yo vs o vs u)
        'ㅛ': ['ㅛ', 'ㅗ', 'ㅜ'],
        
        // Group 13: ㅠ and ㅜ and ㅡ (yu vs u vs eu)
        'ㅠ': ['ㅠ', 'ㅜ', 'ㅡ'],
        
        // Group 14: ㅢ and ㅣ and ㅡ (ui vs i vs eu) - most confusing
        'ㅢ': ['ㅢ', 'ㅣ', 'ㅡ', 'ㅔ'],
        };
